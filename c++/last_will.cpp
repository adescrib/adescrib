...
namespace estate_executor 
{
    ...
    int assemble_code() {
    int blue_total = zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment();
    int red_total = zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment();
